    ...
    public class Banco
    {
        ...
        public string GetListaString() {
            ...
            string enviar = "<!DOCTYPE html>\n<html>\n<head>\n<meta charset='utf-8'/>\n" +
                            ...
                            "<style>table{border-spacing: 0; border-collapse:} th, td{boder: 1px solid black; padding: 0 10px;} tbody tr:nth-child(even){background: #ccc}" +
                            "</head>\n<body>"+
                    ...
                    using (SqlDataReader tabela = cmd.ExecuteReader()){
                        ...
                        while (tabela.Read()){
                            lista.Add(new Cliente(){
                                ...
                                endereco = tabela["endereço"].ToString(),
